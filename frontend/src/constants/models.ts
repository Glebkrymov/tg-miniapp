...
export const MODELS: Model[] = [
  ...
  { model_id: 'kling-2-6-motion-control', name: 'Kling 2.6 Motion Control', category: 'video', credits: 8,   priceUsd: 0.040, description: 'Управление движением', inputs: { image: true, video: true, promptOptional: true } },
  { model_id: 'kling-3-0-motion-control', name: 'Kling 3.0 Motion Control', category: 'video', credits: 9,   priceUsd: 0.045, description: 'Kling 3 + управление движением', inputs: { image: true, video: true, promptOptional: true } },
